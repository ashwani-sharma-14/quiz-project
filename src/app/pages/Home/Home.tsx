    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white p-6 sm:p-10 space-y-10">
      ...
      <div className="bg-white p-8 rounded-2xl shadow-xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {[
            { title: "Total Quizzes", value: "5", color: "text-indigo-600" },
            { title: "Correct Answers", value: "22", color: "text-green-600" },
            { title: "Wrong Answers", value: "8", color: "text-red-500" },
            { title: "Accuracy", value: "73.3%", color: "text-blue-600" },
            {
              title: "Avg Time/Quiz",
              value: "4.5 min",
